...
MAX_LOSS_PER_TRADE_RS = float(os.getenv("FUTURES_MAX_LOSS_PER_TRADE_RS", "2000"))
...
PROFIT_PROTECTION_THRESHOLD_RS = float(os.getenv("FUTURES_PROFIT_PROTECTION_THRESHOLD_RS", "2000"))
