...
| `GET /swing/paper-trades` | Swing's PAPER trades (added 1 Sep 2026) - live + completed simulated baskets, per-leg and total P&L, win rate. Always reachable regardless of `SWING_PAPER_TRADING_ENABLED` so past results stay visible after paper trading is turned off |
