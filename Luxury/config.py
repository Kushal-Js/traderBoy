...
RIBBON_RANKING_PE_ENABLED = os.getenv("LUXURY_RIBBON_RANKING_PE_ENABLED", "true").lower() == "true"
...
ENABLE_MAX_LOSS_HIT_BEFORE_CUTOFF = os.getenv("LUXURY_ENABLE_MAX_LOSS_HIT_BEFORE_CUTOFF", "false").lower() == "true"
...
UNDERLYING_MOVE_CONFIRMATION_ENABLED = os.getenv(
    "LUXURY_UNDERLYING_MOVE_CONFIRMATION_ENABLED", "true"
).lower() == "true"
...
MARKET_OPEN_TIME = os.getenv("LUXURY_MARKET_OPEN_TIME", "09:15")
...
BREAKOUT_LOOKBACK_CANDLES = int(os.getenv("LUXURY_BREAKOUT_LOOKBACK_CANDLES", "5"))
...
BREAKOUT_PAPER_MODE_ENABLED = os.getenv("LUXURY_BREAKOUT_PAPER_MODE_ENABLED", "false").lower() == "true"
